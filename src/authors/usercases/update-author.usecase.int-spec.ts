...
describe('UpdateAuthorUserCase Integration Tests', () => {
    ...
    test('should throws error when id is not provided', async () => {
        const data = {
            id: null,
        }
    ...
    test('should throws error when email is duplicated', async () => {
